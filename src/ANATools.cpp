...
void HEPHero::METCorrection(){
    ...
    if( apply_met_recoil_corr && (dsNameDY == "DYJetsToLL") ){
        ...
        if( (dataset_year == "16") && dataset_HIPM ){
            ...
            /*
            float era_prob = random_recoil_18.Uniform(0.,1.);
            
            if( era_prob < 0.35 ){  // Eras A e B
                
                sigma_ratio = 1.053; 
                sigma_ratio_unc_up = 0.012; 
                sigma_ratio_unc_down = 0.005;
                
                if( Njets_ISR == 0 ){
                    mc_u1_mean = {-40.095, -49.748, -59.832, -70.257, -80.981, -91.942, -102.732, -113.429, -123.623, -134.105, -144.551, -154.252, -165.061, -175.899}; 
                    mc_u1_mean_unc_up = {0.133, 0.148, 0.16, 0.159, 0.183, 0.118, 0.146, 0.011, 0.022, 0.003, 0.102, 0.001, 0.01, 0.005}; 
                    mc_u1_mean_unc_down = {0.02, 0.022, 0.021, 0.02, 0.019, 0.01, 0.006, 0.003, 0.005, 0.115, 0.0, 0.067, 0.068, 0.174};
                    
                    diff_u1 = {1.567, 1.696, 1.958, 2.255, 2.512, 2.677, 2.726, 2.659, 2.5, 2.298, 2.128, 2.09, 2.306, 2.926}; 
                    diff_u1_unc_up = {0.126, 0.168, 0.175, 0.19, 0.221, 0.202, 0.219, 0.291, 0.201, 0.193, 0.22, 0.263, 0.033, 0.038}; 
                    diff_u1_unc_down = {0.032, 0.055, 0.078, 0.095, 0.106, 0.109, 0.103, 0.09, 0.07, 0.046, 0.025, 0.015, 0.335, 0.416};
                    
                    ZRecoPt = {40, 50, 60, 70, 80, 90, 100, 110, 120, 130, 140, 150, 160, 170, 180, 190, 200, 210};
                }else if( Njets_ISR == 1 ){
                    mc_u1_mean = {-44.953, -54.335, -63.929, -73.543, -83.384, -93.289, -103.382, -113.403, -123.569, -133.793, -143.854, -154.052, -164.177, -174.411, -184.814, -194.656, -204.785, -215.366, -225.397, -235.231, -245.514, -255.649, -265.958, -276.117, -286.201}; 
                    mc_u1_mean_unc_up = {0.001, 0.01, 0.03, 0.033, 0.061, 0.062, 0.07, 0.049, 0.045, 0.057, 0.034, 0.034, 0.02, 0.004, 0.032, 0.066, 0.002, 0.042, 0.008, 0.008, 0.011, 0.022, 0.027, 0.027, 0.018}; 
                    mc_u1_mean_unc_down = {0.003, 0.001, 0.002, 0.004, 0.005, 0.005, 0.002, 0.002, 0.004, 0.001, 0.002, 0.003, 0.002, 0.027, 0.013, 0.003, 0.027, 0.0, 0.03, 0.134, 0.155, 0.215, 0.19, 0.162, 0.104};
                    
                    diff_u1 = {0.687, 0.767, 0.843, 0.912, 0.97, 1.014, 1.041, 1.052, 1.045, 1.022, 0.984, 0.935, 0.878, 0.817, 0.758, 0.708, 0.674, 0.665, 0.69, 0.759, 0.883, 1.075, 1.348, 1.716, 2.194}; 
                    diff_u1_unc_up = {0.034, 0.074, 0.095, 0.093, 0.081, 0.069, 0.065, 0.062, 0.071, 0.108, 0.097, 0.063, 0.116, 0.112, 0.175, 0.221, 0.271, 0.321, 0.335, 0.31, 0.315, 0.217, 0.021, 0.037, 0.06}; 
                    diff_u1_unc_down = {0.017, 0.005, 0.007, 0.016, 0.036, 0.059, 0.08, 0.095, 0.101, 0.097, 0.083, 0.058, 0.025, 0.005, 0.003, 0.002, 0.001, 0.005, 0.007, 0.008, 0.009, 0.011, 0.171, 0.497, 0.912};
                    
                    ZRecoPt = {40, 50, 60, 70, 80, 90, 100, 110, 120, 130, 140, 150, 160, 170, 180, 190, 200, 210, 220, 230, 240, 250, 260, 270, 280, 290, 300};
                }else if( Njets_ISR >= 2 ){
                    mc_u1_mean = {-44.822, -54.739, -64.839, -74.557, -84.49, -94.373, -104.127, -114.166, -123.839, -133.969, -143.749, -153.873, -163.771, -174.385, -183.967, -194.166, -204.033, -214.153, -224.354, -234.394, -244.997, -254.86, -264.772, -274.815, -284.916, -294.765}; 
                    mc_u1_mean_unc_up = {0.014, 0.028, 0.065, 0.031, 0.042, 0.055, 0.048, 0.085, 0.083, 0.094, 0.113, 0.087, 0.079, 0.081, 0.123, 0.074, 0.005, 0.083, 0.2, 0.038, 0.011, 0.01, 0.046, 0.005, 0.018, 0.007}; 
                    mc_u1_mean_unc_down = {0.005, 0.007, 0.006, 0.006, 0.006, 0.008, 0.008, 0.006, 0.004, 0.003, 0.006, 0.004, 0.005, 0.0, 0.002, 0.001, 0.003, 0.005, 0.0, 0.002, 0.015, 0.017, 0.029, 0.022, 0.016, 0.014};
                    
                    diff_u1 = {0.569, 0.62, 0.667, 0.711, 0.751, 0.787, 0.819, 0.848, 0.873, 0.895, 0.912, 0.926, 0.936, 0.943, 0.946, 0.945, 0.941, 0.932, 0.92, 0.905, 0.886, 0.863, 0.836, 0.805, 0.771, 0.733}; 
                    diff_u1_unc_up = {0.066, 0.065, 0.108, 0.061, 0.13, 0.116, 0.113, 0.102, 0.109, 0.068, 0.066, 0.112, 0.08, 0.131, 0.124, 0.126, 0.109, 0.262, 0.198, 0.282, 0.312, 0.295, 0.381, 0.325, 0.389, 0.449}; 
                    diff_u1_unc_down = {0.004, 0.025, 0.049, 0.069, 0.085, 0.098, 0.107, 0.112, 0.113, 0.111, 0.105, 0.096, 0.083, 0.066, 0.045, 0.022, 0.006, 0.006, 0.008, 0.013, 0.021, 0.029, 0.038, 0.048, 0.059, 0.071};
                ...
                sigma_ratio = 1.028; 
                sigma_ratio_unc_up = 0.005; 
                sigma_ratio_unc_down = 0.005;
                
                if( Njets_ISR == 0 ){
                    mc_u1_mean = {-40.094, -49.738, -59.818, -70.235, -80.919, -91.87, -102.674, -113.324, -123.575, -134.133, -144.535, -154.185, -165.007, -176.0}; 
                    mc_u1_mean_unc_up = {0.139, 0.155, 0.168, 0.158, 0.187, 0.146, 0.156, 0.042, 0.017, 0.003, 0.099, 0.002, 0.006, 0.0}; 
                    mc_u1_mean_unc_down = {0.02, 0.022, 0.021, 0.021, 0.021, 0.011, 0.004, 0.002, 0.003, 0.082, 0.0, 0.091, 0.068, 0.202};
                    
                    diff_u1 = {1.843, 2.023, 2.319, 2.626, 2.866, 2.994, 2.995, 2.884, 2.706, 2.537, 2.483, 2.68, 3.295, 4.523}; 
                    diff_u1_unc_up = {0.08, 0.148, 0.175, 0.202, 0.223, 0.207, 0.221, 0.256, 0.174, 0.261, 0.262, 0.406, 0.5, 0.847}; 
                    diff_u1_unc_down = {0.031, 0.053, 0.075, 0.092, 0.103, 0.106, 0.101, 0.089, 0.07, 0.047, 0.026, 0.015, 0.016, 0.017};
                    
                    ZRecoPt = {40, 50, 60, 70, 80, 90, 100, 110, 120, 130, 140, 150, 160, 170, 180, 190, 200, 210};
                }else if( Njets_ISR == 1 ){
                    mc_u1_mean = {-44.953, -54.334, -63.925, -73.544, -83.368, -93.276, -103.325, -113.383, -123.558, -133.785, -143.841, -154.025, -164.148, -174.398, -184.781, -194.623, -204.767, -215.312, -225.392, -235.236, -245.365, -255.444, -265.685, -276.01, -286.054}; 
                    mc_u1_mean_unc_up = {0.001, 0.013, 0.033, 0.034, 0.064, 0.065, 0.069, 0.051, 0.043, 0.064, 0.048, 0.043, 0.018, 0.005, 0.034, 0.068, 0.002, 0.036, 0.008, 0.008, 0.014, 0.028, 0.036, 0.025, 0.02}; 
                    mc_u1_mean_unc_down = {0.002, 0.001, 0.002, 0.004, 0.005, 0.005, 0.002, 0.003, 0.004, 0.002, 0.002, 0.003, 0.002, 0.031, 0.014, 0.004, 0.031, 0.003, 0.025, 0.122, 0.161, 0.18, 0.302, 0.179, 0.147};
                    
                    diff_u1 = {0.806, 0.957, 1.076, 1.169, 1.241, 1.296, 1.338, 1.371, 1.397, 1.42, 1.439, 1.457, 1.475, 1.491, 1.505, 1.517, 1.525, 1.525, 1.516, 1.493, 1.454, 1.392, 1.303, 1.182, 1.021}; 
                    diff_u1_unc_up = {0.038, 0.032, 0.044, 0.058, 0.072, 0.095, 0.117, 0.137, 0.155, 0.176, 0.16, 0.102, 0.114, 0.086, 0.112, 0.112, 0.022, 0.027, 0.033, 0.229, 0.309, 0.244, 0.328, 0.688, 1.125}; 
                    diff_u1_unc_down = {0.004, 0.011, 0.019, 0.028, 0.036, 0.044, 0.05, 0.055, 0.056, 0.056, 0.052, 0.047, 0.039, 0.036, 0.05, 0.071, 0.203, 0.212, 0.165, 0.095, 0.061, 0.019, 0.023, 0.046, 0.087};
                    
                    ZRecoPt = {40, 50, 60, 70, 80, 90, 100, 110, 120, 130, 140, 150, 160, 170, 180, 190, 200, 210, 220, 230, 240, 250, 260, 270, 280, 290, 300};
                }else if( Njets_ISR >= 2 ){
                    mc_u1_mean = {-44.818, -54.738, -64.831, -74.548, -84.485, -94.382, -104.129, -114.146, -123.83, -133.954, -143.755, -153.851, -163.78, -174.376, -183.947, -194.145, -204.033, -214.164, -224.297, -234.35, -244.81, -254.57, -264.802, -274.748, -284.778, -294.635}; 
                    mc_u1_mean_unc_up = {0.016, 0.032, 0.069, 0.034, 0.044, 0.061, 0.055, 0.086, 0.087, 0.092, 0.122, 0.098, 0.073, 0.092, 0.138, 0.077, 0.01, 0.095, 0.206, 0.017, 0.016, 0.015, 0.017, 0.006, 0.014, 0.011}; 
                    mc_u1_mean_unc_down = {0.005, 0.007, 0.006, 0.006, 0.006, 0.008, 0.009, 0.006, 0.004, 0.003, 0.006, 0.004, 0.005, 0.0, 0.002, 0.001, 0.003, 0.006, 0.001, 0.001, 0.064, 0.076, 0.031, 0.055, 0.034, 0.046};
                    
                    diff_u1 = {0.619, 0.753, 0.87, 0.97, 1.056, 1.128, 1.187, 1.235, 1.272, 1.301, 1.322, 1.336, 1.345, 1.349, 1.35, 1.349, 1.347, 1.346, 1.346, 1.348, 1.355, 1.366, 1.384, 1.409, 1.443, 1.486}; 
                    diff_u1_unc_up = {0.047, 0.016, 0.024, 0.057, 0.126, 0.137, 0.149, 0.141, 0.159, 0.149, 0.145, 0.14, 0.117, 0.181, 0.121, 0.136, 0.07, 0.075, 0.074, 0.065, 0.049, 0.229, 0.186, 0.413, 0.607, 0.875}; 
                    diff_u1_unc_down = {0.003, 0.054, 0.093, 0.085, 0.098, 0.102, 0.1, 0.091, 0.077, 0.06, 0.04, 0.019, 0.007, 0.007, 0.007, 0.01, 0.119, 0.314, 0.211, 0.282, 0.331, 0.022, 0.033, 0.082, 0.148, 0.23};
