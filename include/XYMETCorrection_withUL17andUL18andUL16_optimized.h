...
std::pair<double,double> METXYCorr_Met_MetPhi(double uncormet, double uncormet_phi, int runnb, string year, bool isMC, int npv, bool isUL=false, bool ispuppi=false){
  ...
  if(!usemetv2){//Current recommendation for 2016 and 2018
    ...
    //UL2018
    if(runera==yUL2018A) METxcorr = -(0.242362*npv +-0.806552);
    if(runera==yUL2018A) METycorr = -(0.0508178*npv +-0.276570);
    if(runera==yUL2018B) METxcorr = -(0.444661*npv +-4.51247);
    if(runera==yUL2018B) METycorr = -(0.0996146*npv +1.50054);
    if(runera==yUL2018C) METxcorr = -(0.423082*npv +-0.759816);
    if(runera==yUL2018C) METycorr = -(0.113674*npv +-3.43027);
    if(runera==yUL2018D) METxcorr = -(0.441594*npv +-0.588983);
    if(runera==yUL2018D) METycorr = -(0.0543516*npv +-0.360043);
    if(runera==yUL2018MC) METxcorr = -(0.098412*npv +3.93989);
    if(runera==yUL2018MC) METycorr = -(0.153362*npv +2.42947);
