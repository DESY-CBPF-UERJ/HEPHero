...
#==================================================================================================
def model_parameters_ResNet(param_dict):
...
#==================================================================================================
def update_ResNet(model, criterion, parameters, batch_data, device):
...
#==================================================================================================
def evaluate_ResNet(input_data, model, i_eval, eval_step_size, criterion, parameters, device, mode):
        ...
        for itl in range(n_kin_features):
            ...
            for irep in range(30):
                ...
                for i_eval in range(n_eval_steps):
                    i_eval_output = evaluate_ResNet(shuffled_data, model, i_eval, eval_step_size, criterion, parameters, device, mode="metric")
...
#==================================================================================================
def save_ResNet(model, model_outpath, dim, device):
